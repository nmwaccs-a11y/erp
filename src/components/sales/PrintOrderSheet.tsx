...
export function PrintOrderSheet({ open, onOpenChange, order }: PrintOrderSheetProps) {
                ...
                <div ref={printRef} className="bg-white p-8 border border-slate-200 shadow-sm print:shadow-none print:border-none">
                    ...
                    <div className="flex justify-between items-start border-b pb-6 mb-6">
                        ...
                        <div className="text-right">
                            <h2 className="text-xl font-semibold text-slate-900">SALES ORDER</h2>
                    ...
                    <div className="grid grid-cols-2 gap-8 mb-8">
                        <div>
                            ...
                            <div className="text-sm text-slate-500">
                                Designated Warehouse<br />
                                Pakistan
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Order #</h3>
                    ...
                    <table className="w-full mb-8">
                        ...
                        <tbody>
                            {order.items && order.items.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan={4} className="py-4 text-center text-slate-500 italic">No items listed</td>
                                </tr>
                            )}
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <td className="pt-4 text-right text-lg font-bold text-blue-600">
                                    {order.items ? order.items.reduce((sum: number, i: any) => sum + (Number(i.qty || 0) * Number(i.rate || 0)), 0).toLocaleString() : "0"}
                                </td>
                            </tr>
                        </tfoot>
                    </table>
                    ...
                    <div className="grid grid-cols-2 gap-8 mt-12 pt-8 border-t border-slate-200">
                        <div>
                            <p className="text-sm text-slate-500">
                                ...
                                2. Payment due within 30 days.<br />
